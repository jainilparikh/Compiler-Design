...
void Quadruple() {
	...
	int id = 0, i;
	for (i=0; i<ind; i++) {
		printf("%d\t", id);							//id of statement
		printf("%c\t", code[i].opr);  	    		//operator
		printf("%c\t", code[i].opd1); 				//operand 1
		printf("%c\t", code[i].opd2); 				//operand 2
